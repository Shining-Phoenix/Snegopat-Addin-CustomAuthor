...
var stdlib = __importStar(require("./std"));
var helpsys = __importStar(require("./help"));
var repo = __importStar(require("./repo"));
var snmain = __importStar(require("./snegopat"));
var hks = __importStar(require("./hotkeys"));
var macroswnd = __importStar(require("./macroswnd"));
