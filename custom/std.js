...
var stdcommands = __importStar(require("./commands"));
...
exports.DocKinds = {
    ...
    TextOem: '74d75a51-58b7-46b0-931a-f3bac20e596e',
    Epf: '0e0e54cf-253b-4fc9-a895-26897e1a51f7',
    Erf: '6d01520c-23c6-4301-86f7-e81268f07ee3',
    Moxel: 'e555a6fe-768f-476a-bf4b-1d945aa56099',
    Config: 'c64ce8a4-a74d-40e9-996e-feadca885e11',
...
exports.openFileIn1C = openFileIn1C;
/**
...
exports.isConfigOpen = isConfigOpen;
/**
...
exports.isConfigModified = isConfigModified;
// Узнать, отличается ли конфигурация от конфигурации ИБ
function isConfigsDifferent() {
    var s = stdcommands.Config.UpdateDBCfg.getState();
    return s && s.enabled;
}
exports.isConfigsDifferent = isConfigsDifferent;
/**
 ...
 * сообщение.
 */
SelfScript.self['require'] = function (filename, scriptCaller, strict) {
 ...
 */
function getUuidFomMDRef(mdRefValue) {
    return "{" + toV8Value(mdRefValue).toStringInternal().split("\n")[1].split(",")[1];
}
exports.getUuidFomMDRef = getUuidFomMDRef;
/**
 * Возвращает путь к корневому каталогу Снегопата.
 */
function getSnegopatMainFolder() {
    return env.pathes.main;
}
exports.getSnegopatMainFolder = getSnegopatMainFolder;
/**
...
exports.Class["extend"] = function (def) {
    var classDef = function () {
        if (arguments[0] !== exports.Class) {
            this.construct.apply(this, arguments);
        }
    };
    var _super = this.prototype;
    var proto = new this(exports.Class);
    for (var n in def) {
        var item = def[n];
 ...
 */
function createMacros(script, name, descr, picture, macros, predefHotKey) {
...
exports.createMacros = createMacros;
function getAllPredefHotKeys(script, predef) {
    for (var k in script) {
        try {
...
exports.getAllPredefHotKeys = getAllPredefHotKeys;
